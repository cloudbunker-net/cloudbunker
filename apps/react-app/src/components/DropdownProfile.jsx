...
// ? Most likely we need to remove this, we don't use custom skeletons
		...
		<div className="relative inline-flex">
			...
			>
				<div className="flex items-center truncate">
					...
					{!isLoading && !user && (
						<span className="truncate ml-2 text-sm font-medium text-black group-hover:text-slate-700">[not logged in]</span>
					)}
					{!isLoading && user && (
						<span className="truncate ml-2 text-sm font-medium text-black group-hover:text-slate-700">{user.email}</span>
					)}

					<svg className="w-3 h-3 shrink-0 ml-1 fill-current text-[#3F7CAC]" viewBox="0 0 12 12">
