...
function InvoicesTableItem(props) {
  ...
  return (
    <tr className="border-b border-gray-200 text-black">
      ...
      <td className="px-2 first:pl-5 last:pr-5 whitespace-nowrap">
        <div
          className={`inline-flex font-medium rounded-sm text-center px-3 ${statusColor(
            props.shared
          )}`}
        >
          {props.shared}
      ...
      <td className="px-2 first:pl-5 last:pr-5 whitespace-nowrap w-px">
        <div className="space-x-1">
          ...
          <button className="hover:text-[#A3320B] text-[#BF3A0D] rounded-full">
